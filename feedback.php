      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-4 text-center">
            <!-- put the ULK logo file at image/ulk_logo.png -->
            <img src="image/ulk_logo.png" width="100" height="100" alt="ULK Gisenyi Campus" class="img-rounded img-responsive center-block" onerror="this.style.display='none'">
          </div>
          <div class="col-md-8">
            <p><strong>Rukundo Janvier vs Shyaka Aime</strong></p>
            <p>ULK Gisenyi Campus</p>
            <p style="font-size:0.8em;color:#888">(logo must be placed at <code>image/ulk_logo.png</code>)</p>
          </div>
        </div>
      </div>
