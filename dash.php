  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dash.php?q=6">Payments</a></li>
...
<?php if(@$_GET['q']==0) {
    // admin home: redirect to user management or show welcome message
    echo '<div class="panel"><div class="container"><h2>Welcome, Admin</h2><p>Use the menu on top to manage users, quizzes, rankings, and feedback.</p><p><strong>Developed by:</strong> Rukundo and Aime (ULK Gisenyi Campus)</p></div></div>';
}
...
<?php if(@$_GET['q']==6) {
    // show payments table
    $pq = mysqli_query($con,"SELECT * FROM payment ORDER BY date DESC") or die('Error');
    echo '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
    <tr><td><b>S.N.</b></td><td><b>Email</b></td><td><b>Topic ID</b></td><td><b>Amount</b></td><td><b>Method</b></td><td><b>Status</b></td><td><b>Date</b></td></tr>';
    $c=1;
    while($prow = mysqli_fetch_array($pq)){
        echo '<tr><td>'.$c++.'</td><td>'.$prow['email'].'</td><td>'.$prow['eid'].'</td><td>'.$prow['amount'].'</td><td>'.$prow['method'].'</td><td>'.$prow['status'].'</td><td>'.$prow['date'].'</td></tr>';
    }
    echo '</table></div></div>';
}
    ?>
